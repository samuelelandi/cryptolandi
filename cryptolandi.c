...
int cl_decrypt_file(const char * infile, const char * outfilefinal, char *key){
  ...
  memset(keyaesb64,0x0,128);
  memset(ivaesb64,0x0,64);
  memset(tagaesb64,0x0,64);
  memset(keycamelliab64,0x0,128);
  memset(ivcamelliab64,0x0,64);
  memset(keychachab64,0x0,128);
  memset(ivchachab64,0x0,64);
  memset(hash,0x0,128);
